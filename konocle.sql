...
COPY categories (category_id, category_display_name, category_created_date, category_link_name, category_wiki) FROM stdin;
\.
...
SELECT pg_catalog.setval('categories_disciplines_categories_disciplines_id_seq', 50, true);
...
SELECT pg_catalog.setval('disciplines_discipline_id_seq', 22, true);
...
ALTER TABLE ONLY categories
    ADD CONSTRAINT "Name must be unique" UNIQUE (category_display_name);
